...
describe('ShareManager', () => {
  ...
  const baseUrl = 'https://share.social-archiver.com';
  ...
  describe('initialization', () => {
    ...
    it('should use default base URL if not provided', () => {
      ...
      expect(defaultManager.generateShareUrl(shareId)).toBe(`https://share.social-archiver.com/${shareId}`);
    });
  });
    ...
    describe('parseShareResponse', () => {
      it('should parse successful response', () => {
        const response = {
          ...
          data: {
            shareId: 'abc123',
            shareUrl: 'https://share.social-archiver.com/abc123',
        ...
        expect(result.shareUrl).toBe('https://share.social-archiver.com/abc123');
